...
//         <label htmlFor="proforma-select" className={styles.label}>
//           انتخاب فرم برآورد هزینه:
//         </label>
//         <select
//           id="proforma-select"
...
//             <h3>مشخصات:</h3>
//             <p>
//               <strong>نام مشتری:</strong> {this.state.selectedItem.CustomerName}
//             </p>
//             <p>
//               <strong>شماره فرم:</strong>{" "}
//               {this.state.selectedItem.ProformaNumber}
//             </p>
//             <p>
//               <strong>تاریخ ایجاد:</strong>{" "}
//               {this.state.selectedItem.Created.toLocaleDateString("fa-IR")}
//             </p>
//           </div>
//         )}
